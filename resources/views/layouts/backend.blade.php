...
<head>
    ...
    -->
    <link rel="stylesheet" href="{{ asset('AdminLTE-2.3.7/dist/css/skins/skin-blue.min.css') }}">
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="/" class="logo">
            ...
            <span class="logo-mini"><b>L</b>Kit</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>Laravel</b>Starterkit</span>
        </a>
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href="{{ route('backend.articleCategory.index') }}">Article Categories</a></li>
                    </ul>
                </li>
