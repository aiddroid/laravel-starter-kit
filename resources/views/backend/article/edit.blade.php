...
@section('content')
    <div class="box">
        ...
        <div class="box-body">
            {!! Form::model($article, ['route' => ['backend.article.update', $article->id], 'class' => 'form-vertical', 'role' => 'form', 'method' => 'post', 'files' => true]) !!}
            ...
            <div class="form-group">
                ...
                {!! Html::image(asset('/uploads/icons/'.$article->icon_image), null, ['class' => 'form-control','style' => 'width:100px;height:100px;padding:5px;']) !!}
